...
CFILES=EMothership.cpp Background.cpp Bsplit.cpp EntityManager.cpp ESplit.cpp Bullet.cpp E3shot.cpp Player.cpp Entity.cpp GameState.cpp main.cpp Game.cpp Utils.cpp Enemy.cpp 
BIN=ft_shmup
